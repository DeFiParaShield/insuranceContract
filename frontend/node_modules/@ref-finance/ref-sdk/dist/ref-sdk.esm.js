...
var icons = {
  '4691937a7508860f876c9c0a2a617e7d9e945d4b.factory.bridge.near': 'https://ref-finance-images.s3.amazonaws.com/images/woo-wtrue.png',
...
var singlePoolSwap = function singlePoolSwap(_ref3) {
  ...
  var maxSimplePoolEstimate = estimatesSimplePool === undefined || estimatesSimplePool.length === 0 ? undefined : estimatesSimplePool.length === 1 ? estimatesSimplePool[0] : _.maxBy(estimatesSimplePool, function (estimate) {
    return Number(estimate.estimate);
  });
  var maxStablePoolEstimate = estimatesStablePool === undefined || estimatesStablePool.length === 0 ? undefined : estimatesStablePool.length === 1 ? estimatesStablePool[0] : _.maxBy(estimatesStablePool, function (estimate) {
    return Number(estimate.estimate);
  });
...
var calculateExchangeRate = function calculateExchangeRate(from, to, precision) {
  return floor(evaluate(to + " / " + from), precision || 4).toString();
};
...
var multiply = function multiply(factor1, factor2) {
  return format(evaluate(factor1 + " * " + factor2), {
    notation: 'fixed'
  });
};
...
var percentOfBigNumber = function percentOfBigNumber(percent, num, precision) {
  var valueBig = bignumber(num);
  var percentBig = bignumber(percent).div(100);
...
var calculateFeeCharge = function calculateFeeCharge(fee, total) {
  return floor(evaluate("(" + fee + " / " + FEE_DIVISOR + ") * " + total), 3);
};
var calculateFeePercent = function calculateFeePercent(fee) {
  return divide$1(fee, 100);
};
...
var calculateAmountReceived = function calculateAmountReceived(pool, amountIn, tokenIn, tokenOut) {
  ...
  var in_balance = toReadableNumber(tokenIn.decimals, pool.supplies[tokenIn.id]);
  var out_balance = toReadableNumber(tokenOut.decimals, pool.supplies[tokenOut.id]);
  var big_in_balance = bignumber(in_balance);
  var big_out_balance = bignumber(out_balance);
  var constant_product = big_in_balance.mul(big_out_balance);
  var new_in_balance = big_in_balance.plus(bignumber(partialAmountIn));
...
var calculateMarketPrice = function calculateMarketPrice(pool, tokenIn, tokenOut) {
  ...
  return evaluate("(" + cur_in_balance + " / " + cur_out_balance + ")");
};
var calculateSmartRoutingPriceImpact = function calculateSmartRoutingPriceImpact(tokenInAmount, swapTodos, tokenIn, tokenMid, tokenOut, stablePools) {
  ...
  var generalMarketPrice = evaluate(marketPrice1 + " * " + marketPrice2);
  ...
  var newMarketPrice = evaluate(tokenInAmount + " / " + tokenOutReceived);
...
var percent = function percent(numerator, denominator) {
  return evaluate("(" + numerator + " / " + denominator + ") * 100");
};
var calcStableSwapPriceImpact = function calcStableSwapPriceImpact(from, to, marketPrice) {
  if (marketPrice === void 0) {
    marketPrice = '1';
  }
  var newMarketPrice = evaluate(from + " / " + to);
  return format(percent(evaluate(newMarketPrice + " - " + marketPrice), newMarketPrice), {
    notation: 'fixed'
  });
};
var calculatePriceImpact = function calculatePriceImpact(pools, tokenIn, tokenOut, tokenInAmount) {
  ...
  var finalMarketPrice = evaluate("(" + in_balance + " / " + out_balance + ")");
  ...
  var finalTokenOutReceived = sum.apply(math, separatedReceivedAmount);
  var newMarketPrice = evaluate(tokenInAmount + " / " + finalTokenOutReceived);
...
var getPriceImpact = function getPriceImpact(_ref) {
  ...
  try {
    if ((estimates == null ? void 0 : estimates.length) === 2 && estimates[0].status === PoolMode.SMART) {
    ...
    } else if ((estimates == null ? void 0 : estimates.length) === 1 && estimates[0].status === PoolMode.STABLE) {
  ...
  try {
    if (estimates[0].status === PoolMode.SMART || estimates[0].status === PoolMode.STABLE) {
...
var ThemeContextProvider = function ThemeContextProvider(_ref) {
  ...
  var _useState = useState(customTheme || defaultTheme),
    theme = _useState[0],
...
var TokenPriceContext = /*#__PURE__*/createContext(null);
...
var TokenPriceContextProvider = function TokenPriceContextProvider(_ref7) {
  ...
  return React.createElement(TokenPriceContext.Provider, {
...
var getPriceImpact$1 = function getPriceImpact(value, tokenIn, tokenInAmount) {
  ...
  if (Number(value) < 0.01) return React.createElement("span", {
    className: "text-greenLight"
  }, "< -0.01%", tokenInInfo);
  if (Number(value) > 1000) return React.createElement("span", {
...
var SmartRouteV2 = function SmartRouteV2(_ref) {
  ...
  var Hub = function Hub(_ref4) {
    ...
    }, "#" + poolId)), React.createElement(Icon, {
      token: token
    }));
  };
  if (tokens.length === 3) {
    ...
    }, React.createElement(ParaTokenFrom, {
      tokenIn: tokens[0],
      p: p
    }), React.createElement("div", {
      className: "",
    ...
    }, React.createElement(ArrowRight, null)), React.createElement(Hub, {
      token: tokens[1],
...
var DetailView = function DetailView(_ref5) {
  ...
  var _useState = useState(storagedOpen || false),
  ...
  var percents = useMemo(function () {
    if (!pools || pools.length === 0) return [];
    return getPoolAllocationPercents(pools);
  }, [pools]);
  var priceImpactDisplay = useMemo(function () {
  ...
  return React.createElement("div", {
  ...
  }, React.createElement("div", null, "Detail"), React.createElement("div", {
    style: {
      position: 'relative'
    }
  }, !showDetail ? React.createElement(FiChevronDown, null) : React.createElement(FiChevronUp, null))), amountIn && amountOut && React.createElement("div", {
    className: "__ref-swap-widget-row-flex-center"
  }, React.createElement("div", null, isRateReverse ? revertDisplayRate : displayRate), React.createElement(RiExchangeFill, {
    onClick: function onClick() {
    ...
    fill: iconDefault
  }))), !showDetail ? null : React.createElement(React.Fragment, null, React.createElement("div", {
    className: "__ref-swap-widget-row-flex-center __ref-swap-widget-swap-detail-view-item"
  }, React.createElement("div", null, "Minimum received"), React.createElement("div", null, toPrecision(minReceived || '0', 8))), React.createElement("div", {
    className: "__ref-swap-widget-row-flex-center __ref-swap-widget-swap-detail-view-item"
  }, React.createElement("div", null, "Fee"), React.createElement("div", null, !amountIn ? '0' : calculateFeeCharge(fee, amountIn) + " " + toRealSymbol(tokenIn.symbol) + "(" + toPrecision(calculateFeePercent(fee).toString(), 2) + "%)"))), !showDetail ? null : React.createElement(React.Fragment, null, React.createElement("div", {
    className: "__ref-swap-widget-row-flex-center __ref-swap-widget-swap-detail-view-item"
  }, React.createElement("div", null, "Price impact"), React.createElement("div", null, priceImpactDisplay))), estimates && estimates.length > 1 && showDetail && React.createElement("div", {
    ...
    className: "__ref-swap-widget-row-flex-center"
  }, React.createElement(RouterIcon, null), React.createElement("span", {
    className: "__ref-swap-widget-valueStyle",
    style: {
      marginLeft: '4px',
      whiteSpace: 'nowrap'
    }
  }, 'Auto Router')), React.createElement("div", {
    className: "",
    style: {
    ...
    return React.createElement(SmartRouteV2, {
...
var TokenAmount = function TokenAmount(props) {
  ...
  }), React.createElement("span", null, toRealSymbol(token == null ? void 0 : token.symbol))), React.createElement(FiChevronDown, {
    style: {
      marginLeft: '4px',
      flexShrink: 0
    }
  })), onForceUpdate && React.createElement(RiRefreshLine, {
  ...
  }, !price ? '$-' : '~$' + toInternationalCurrencySystemLongString(multiply(price, amount || '0'), 2)))), !balance || !token || !onChangeAmount ? null : React.createElement("div", {
...
var SlippageSelector = function SlippageSelector(_ref8) {
  ...
  }, "Slippage tolerance"), React.createElement("div", {
    className: "__ref-swap-widget-row-flex-center\n      "
  }, React.createElement("div", {
    className: "__ref-swap-widget-row-flex-center\n        __ref-swap-widget_slippage_selector_input_container",
    style: {
...
var StarToken = function StarToken(_ref10) {
  ...
  }, hoverIcon && React.createElement("div", {
    style: {
      position: 'absolute',
      top: '-4px',
      right: '-4px',
  ...
  }, toRealSymbol(token.symbol)), React.createElement("span", {
    style: {
      fontSize: '10px',
      color: secondary
    }
...
var Token = function Token(_ref11) {
  ...
  return React.createElement("div", {
    ...
    className: "__ref-swap-widget-row-flex-center"
  }, toRealSymbol(token.symbol), TokenLinks[token.symbol] && React.createElement(HiOutlineExternalLink, {
    onMouseEnter: function onMouseEnter() {
  ...
  }, !price ? '$-' : '$' + toInternationalCurrencySystemLongString(price, 2)))), React.createElement("div", {
    className: "__ref-swap-widget-row-flex-center",
    style: {
      color: primary
    }
  }, displayBalance, isSticky ? React.createElement(AiFillPushpin, {
    onMouseEnter: function onMouseEnter() {
  ...
  }) : React.createElement(AiOutlinePushpin, {
    style: {
      marginLeft: '10px',
      cursor: 'pointer'
    },
...
var TokenListTable = function TokenListTable(_ref12) {
  ...
  return !tokens || tokens.length === 0 ? null : React.createElement("div", {
    ...
    className: ""
  }, "Asset"), React.createElement("span", {
    onClick: function onClick() {
    ...
    className: "ml-1"
  }, "Balance"), currentSort === 'up' ? React.createElement(TiArrowSortedUp, null) : React.createElement(TiArrowSortedDown, null))), React.createElement("div", {
...
var TokenSelector = function TokenSelector(_ref13) {
  ...
  var tokenPriceList = useContext(TokenPriceContext);
  ...
  return React.createElement("div", {
  ...
  }, "Select a token"), React.createElement("div", {
    ...
    return !token ? null : React.createElement(StarToken, {
  ...
  })), React.createElement(TokenListTable, {
...
var Notification = function Notification(_ref15) {
  ...
  return React.createElement("div", {
  ...
  }, state === null && React.createElement(Loading, null), state === 'fail' && React.createElement(Warning, null), state === 'success' && React.createElement(Success, null)), React.createElement("div", {
    style: {
      fontSize: '16px',
      marginTop: '10px',
      marginBottom: '6px'
    }
  }, state === 'success' && React.createElement("p", null, "Success!"), state === 'fail' && React.createElement("p", null, "Swap Failed!")), React.createElement("div", {
    ...
    rel: "noreferrer"
  }, "Click to view."), state === 'success' && detail), state !== null && React.createElement("button", {
...
var AccountButton = function AccountButton(_ref16) {
  ...
  var primary = theme.primary,
    secondaryBg = theme.secondaryBg,
    borderColor = theme.borderColor;
  return !AccountId ? null : React.createElement("div", {
...
var SwapWidget = function SwapWidget(props) {
  ...
  return React.createElement(ThemeContextProvider, {
  ...
  }, React.createElement(CgArrowsExchangeAltV, {
    style: {
      cursor: 'pointer'
    },
    ...
    estimates: estimates
  }), swapError && React.createElement("div", {
    className: "__ref-swap-widget-row-flex-center",
    style: {
      color: '#DE9450',
      fontSize: '14px',
  ...
  }, React.createElement(TiWarning, {
    fill: "#DE9450",
    size: 20
  }), "\xA0", swapError.message), isSignedIn ? React.createElement("button", {
    type: "submit",
    ...
    disabled: !canSubmit
  }, 'Swap') : React.createElement("button", {
    type: "button",
    className: "__ref-swap-widget-submit-button __ref-swap-widget-button",
    onClick: onConnect,
    style: {
  ...
  }, 'Connect Wallet'), React.createElement("div", {
    className: "__ref-swap-widget-row-flex-center",
    style: {
      justifyContent: 'center'
    }
    ...
    AccountId: AccountId,
    className: className
  }), widgetRoute === 'token-selector-out' && React.createElement(TokenSelector, {
    tokens: tokens,
    balances: balances,
    width: width,
    onSelect: function onSelect(token) {
