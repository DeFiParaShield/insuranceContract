(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@near-wallet-selector/core'), require('@walletconnect/sign-client'), require('@walletconnect/qrcode-modal')) :
	typeof define === 'function' && define.amd ? define(['exports', '@near-wallet-selector/core', '@walletconnect/sign-client', '@walletconnect/qrcode-modal'], factory) :
	(global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.WalletConnect = {}, global.core, global.Client, global.QRCodeModal));
})(this, (function (exports, core, Client, QRCodeModal) { 'use strict';
	...
	var uncurryThis$i = NATIVE_BIND$3 && bind$5.bind(call$e, call$e);
	  ...
	  return [
	    ...
	    function split(separator, limit) {
	      ...
	      return splitter
	        ...
	        : call$5(internalSplit, toString(O), separator, limit);
	    },
	...
	***************************************************************************** */
	...
	class WalletConnectClient {
	  init(opts) {
	    return __awaiter(this, void 0, void 0, function* () {
	      this.client = yield Client__default["default"].init(opts);
	    });
	  }
	    ...
	    return __awaiter(this, void 0, void 0, function* () {
	      return new Promise((resolve, reject) => {
	        this.client.connect(params).then(({
	          ...
	          if (uri) {
	            QRCodeModal__default["default"].open(uri, () => {
	              reject(new Error("User cancelled pairing"));
	            });
	          }

	          approval().then(resolve).catch(reject).finally(() => QRCodeModal__default["default"].close());
	        }).catch(reject);
	      });
	    });
	  }
	...
	const WalletConnect = ({
	  ...
	  const setupEvents = () => {
	    ...
	    _state.subscriptions.push(_state.client.on("session_delete", event => __awaiter(void 0, void 0, void 0, function* () {
	      var _a;
