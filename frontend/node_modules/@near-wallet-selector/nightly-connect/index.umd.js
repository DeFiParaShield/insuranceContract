(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('near-api-js'), require('@nightlylabs/connect'), require('@near-wallet-selector/core'), require('@near-wallet-selector/wallet-utils')) :
	typeof define === 'function' && define.amd ? define(['exports', 'near-api-js', '@nightlylabs/connect', '@near-wallet-selector/core', '@near-wallet-selector/wallet-utils'], factory) :
	(global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.NightlyConnect = {}, global.nearApiJs, global.connect, global.core, global.walletUtils));
})(this, (function (exports, nearApiJs, connect, core, walletUtils) { 'use strict';
	...
	***************************************************************************** */
	...
	const setupNightlyConnectState = () => {
	  return {
	    client: null,
	    modal: new connect.NightlyConnectModal(),
	    accounts: []
	  };
	};
	    ...
	    signIn() {
	      return __awaiter(this, void 0, void 0, function* () {
	        return new Promise((resolve, reject) => {
	          ...
	          try {
	            connect.AppNear.build(Object.assign(Object.assign({}, params), {
	              ...
	              _state.modal.openModal(client.sessionId, connect.NETWORK.NEAR);
	...
	exports.setupNightlyConnect = setupNightlyConnect;
