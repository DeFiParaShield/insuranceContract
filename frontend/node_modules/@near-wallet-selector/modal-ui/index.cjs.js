...
var uncurryThis$g = NATIVE_BIND$3 && bind$5.bind(call$b, call$b);
...
var ordinaryToPrimitive$1 = function (input, pref) {
  var fn, val;
  if (pref === 'string' && isCallable$d(fn = input.toString) && !isObject$4(val = call$9(fn, input))) return val;
  if (isCallable$d(fn = input.valueOf) && !isObject$4(val = call$9(fn, input))) return val;
  if (pref !== 'string' && isCallable$d(fn = input.toString) && !isObject$4(val = call$9(fn, input))) return val;
...
if (NATIVE_WEAK_MAP || shared.state) {
  ...
  set$1 = function (it, metadata) {
    if (hasOwn$8(it, STATE)) throw new TypeError$9(OBJECT_ALREADY_INITIALIZED);
    metadata.facade = it;
...
var defineIterator$1 = function (Iterable, NAME, IteratorConstructor, next, DEFAULT, IS_SET, FORCED) {
  ...
  if (IterablePrototype[ITERATOR$4] !== defaultIterator) {
    redefine$2(IterablePrototype, ITERATOR$4, defaultIterator, { name: DEFAULT });
  }
...
var engineIsNode = classof$2(global$c.process) == 'process';
...
const HardwareWalletAccountsForm = ({
  ...
  return jsxRuntime.jsxs("div", Object.assign({
    ...
    children: [jsxRuntime.jsx("p", {
      children: "Multiple accounts found. Please choose an account per derivation path."
    }, void 0), jsxRuntime.jsx("form", Object.assign({
      className: "form",
      onSubmit: e => {
      ...
      children: jsxRuntime.jsxs("div", {
        children: [hardwareWalletAccounts.map((account, accountIndex) => {
          return jsxRuntime.jsxs("div", Object.assign({
            className: "form-control"
          }, {
            children: [jsxRuntime.jsx("label", {
              children: account.derivationPath
            }, void 0), jsxRuntime.jsx("select", Object.assign({
              ...
              children: account.accountIds.map(accountId => {
...
const DerivationPath = ({
  ...
  const [derivationPaths, setDerivationPaths] = react.useState([{
    path: DEFAULT_DERIVATION_PATH
  }]);
  const [hardwareWalletAccounts, setHardwareWalletAccounts] = react.useState([]);
  const [showMultipleAccountsSelect, setShowMultipleAccountsSelect] = react.useState(false);
  ...
  const handleDerivationPathRemove = index => {
    setDerivationPaths(prevDerivationPaths => {
  ...
  const handleDerivationPathChange = (index, e) => {
    setDerivationPaths(prevDerivationPaths => {
  ...
  const getAccountIdsFromPublicKey = publicKey => __awaiter(void 0, void 0, void 0, function* () {
  ...
  const resolveAccounts = wallet => __awaiter(void 0, void 0, void 0, function* () {
    ...
    for (let i = 0; i < derivationPaths.length; i += 1) {
      ...
      if (wallet.type === "hardware") {
        ...
        const accountIds = yield getAccountIdsFromPublicKey(publicKey);
        accounts.push({
          derivationPath,
          publicKey,
          accountIds,
  ...
  const signIn = (wallet, contractId, methodNames, accounts) => {
  ...
  const handleConnectClick = () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
      ...
      if (!multipleAccounts) {
        ...
        return signIn(wallet, options.contractId, options.methodNames, mapAccounts);
      } else {
        setConnecting(false);
  ...
  const handleMultipleAccountsSignIn = accounts => __awaiter(void 0, void 0, void 0, function* () {
    yield signIn(hardwareWallet, options.contractId, options.methodNames, accounts);
  });

  const handleAccountChange = (derivationPath, selectedAccountId) => {
    setHardwareWalletAccounts(accounts => {
      const mapAccounts = accounts.map(account => {
        const selectedId = derivationPath === account.derivationPath ? selectedAccountId : account.selectedAccountId;
  ...
  return jsxRuntime.jsx("div", Object.assign({
    ...
    children: showMultipleAccountsSelect ? jsxRuntime.jsx(HardwareWalletAccountsForm, {
      ...
      children: [jsxRuntime.jsx("p", {
        children: "Make sure your device is plugged in, then enter an account id to connect:"
      }, void 0), jsxRuntime.jsx("div", Object.assign({
        className: "derivation-path-list"
      }, {
        children: derivationPaths.map((path, index) => {
          return jsxRuntime.jsxs("div", {
            ...
            }, void 0), index !== 0 && jsxRuntime.jsx("button", Object.assign({
              type: "button",
              title: "Remove",
              onClick: () => handleDerivationPathRemove(index)
            }, {
              children: "-"
            }), void 0), index === derivationPaths.length - 1 && jsxRuntime.jsx("button", Object.assign({
              title: "Add",
              type: "button",
...
const WalletNotInstalled = ({
  ...
  return jsxRuntime.jsxs("div", Object.assign({
    ...
    children: [jsxRuntime.jsxs("div", Object.assign({
      ...
      children: [`You'll need to install ${module.metadata.name} to continue. After installing`, jsxRuntime.jsx("span", Object.assign({
  ...
  return jsxRuntime.jsxs("div", Object.assign({
    ...
    children: [jsxRuntime.jsx("div", {
      ...
      children: [jsxRuntime.jsxs("div", Object.assign({
        ...
        }, void 0), route.name === "WalletOptions" && jsxRuntime.jsx(WalletOptions, {
          selector: selector,
          options: options,
        ...
        }, void 0), route.name === "DerivationPath" && jsxRuntime.jsx(DerivationPath, {
          selector: selector,
          options: options,
          onConnected: handleDismissClick,
          params: route.params,
        ...
        }, void 0), route.name === "WalletNetworkChanged" && jsxRuntime.jsx(WalletNetworkChanged, {
          selector: selector,
          onSwitchWallet: () => setRoute({
            name: "WalletOptions"
          }),
          onDismiss: handleDismissClick
        }, void 0), route.name === "WalletNotInstalled" && jsxRuntime.jsx(WalletNotInstalled, {
        ...
        }, void 0), route.name === "WalletConnecting" && jsxRuntime.jsx(WalletConnecting, {
