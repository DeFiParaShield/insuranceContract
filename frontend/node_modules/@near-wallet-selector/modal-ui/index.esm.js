        ...
        children: modules.reduce((result, module) => {
          ...
          result.push(jsx("li", Object.assign({
            ...
            children: jsxs("div", Object.assign({
              ...
              }, void 0), selected && jsx("div", Object.assign({
      ...
      children: jsxs("div", {
        children: [hardwareWalletAccounts.map((account, accountIndex) => {
          return jsxs("div", Object.assign({
            ...
            }, void 0), jsx("select", Object.assign({
...
const DerivationPath = ({
  ...
  const [showMultipleAccountsSelect, setShowMultipleAccountsSelect] = useState(false);
  ...
  return jsx("div", Object.assign({
    ...
    children: showMultipleAccountsSelect ? jsx(HardwareWalletAccountsForm, {
      ...
      children: [jsx("p", {
        ...
        children: derivationPaths.map((path, index) => {
          return jsxs("div", {
            ...
            }, void 0), index !== 0 && jsx("button", Object.assign({
              type: "button",
              title: "Remove",
              onClick: () => handleDerivationPathRemove(index)
            }, {
              children: "-"
            }), void 0), index === derivationPaths.length - 1 && jsx("button", Object.assign({
              title: "Add",
              type: "button",
  ...
  return jsxs("div", Object.assign({
    ...
    children: [jsx("div", {
      ...
      children: [jsxs("div", Object.assign({
        ...
        }, void 0), route.name === "WalletOptions" && jsx(WalletOptions, {
          selector: selector,
          options: options,
        ...
        }, void 0), route.name === "DerivationPath" && jsx(DerivationPath, {
          selector: selector,
          options: options,
          onConnected: handleDismissClick,
          params: route.params,
        ...
        }, void 0), route.name === "WalletNetworkChanged" && jsx(WalletNetworkChanged, {
          selector: selector,
          onSwitchWallet: () => setRoute({
            name: "WalletOptions"
          }),
          onDismiss: handleDismissClick
        }, void 0), route.name === "WalletNotInstalled" && jsx(WalletNotInstalled, {
        ...
        }, void 0), route.name === "WalletConnecting" && jsx(WalletConnecting, {
